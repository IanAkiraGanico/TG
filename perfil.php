											...
											echo("<blockquote>");
												...
												echo("<div class='timelineposts' id=" . $r['id'] . ">");
													...
													echo("<footer>");
														...
														$requestId = $r['id'];
														$displaycomments = DB::query('SELECT comentarios.comentario, comentarios.posted_at, usuarios.username FROM comentarios, usuarios WHERE comentarios.request_id=:requestid AND comentarios.user_id=usuarios.id ORDER BY comentarios.posted_at', array(':requestid'=>$requestId));
																	...
																	echo("<blockquote>");
																		...
																		echo("<div class='timelineposts'>");
																			...
																			echo("<footer>");
																				...
																				echo("Postado por " . $r['nome_completo'] . " no dia " . date('d-m-Y H:i:s', strtotime($dc['posted_at'])) );
